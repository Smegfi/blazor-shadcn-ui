    ...
    partial class ComboboxDemo
    {
        ...
        private static readonly IReadOnlyList<DemoPropRow> _comboboxProps =
            [
                ...
                new("IconSelector",      "Func<TItem, string?>?", null,    "Optional. Returns a Lucide icon name for each item. Items with no icon get a fixed-width spacer for text alignment."),
                ...
                new("SearchInterval",    "int",                   "0",     "Debounce interval in milliseconds before the search query is applied. Set to 150–300ms for large datasets or server-side search."),
